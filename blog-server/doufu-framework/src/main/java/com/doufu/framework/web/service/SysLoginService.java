...
import com.doufu.common.exception.user.*;
...
import com.doufu.framework.security.context.AuthenticationContextHolder;
...
public class SysLoginService {
    ...
    public String login(String username, String password, String code, String uuid) {
        ...
        try {
            ...
            authentication = authenticationManager.getObject().authenticate(authenticationToken);
        } catch (Exception e) {
