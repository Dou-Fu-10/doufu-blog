package com.doufu.framework.web.exception;

import com.doufu.common.constant.HttpStatus;
import com.doufu.common.core.domain.AjaxResult;
import com.doufu.common.exception.DemoModeException;
...
public class GlobalExceptionHandler {
    ...
    public AjaxResult handleWarnException(WarnException e, HttpServletRequest request) {
        log.error(e.getMessage(), e);
        Integer code = e.getCode();
        return StringUtils.isNotNull(code) ? AjaxResult.error(code, e.getMessage()) : AjaxResult.error(e.getMessage());
    }
